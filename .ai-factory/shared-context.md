...
## In Progress
- 0003: 포맷/날짜/ID 유틸 (TDD red phase)
  - Tests written: src/__tests__/packet-0003.test.ts (47 tests covering all 5 ACs)
  - Waiting for implementation: src/lib/format.ts, src/lib/date.ts, src/lib/id.ts
  - Context: 2026-08-31 (AI-Developer Context)
